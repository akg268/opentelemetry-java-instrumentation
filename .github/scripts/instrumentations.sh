...
readonly INSTRUMENTATIONS=(
  ...
  "apache-dubbo-2.7:javaagent:testDubboStableSemconv"
  ...
  "apache-httpclient:apache-httpclient-2.0:javaagent:testStableSemconv"
  ...
  "armeria:armeria-grpc-1.14:javaagent:testStableSemconv"
  "async-http-client:async-http-client-1.8:javaagent:test"
  "async-http-client:async-http-client-1.8:javaagent:testStableSemconv"
  "async-http-client:async-http-client-1.9:javaagent:test"
  "async-http-client:async-http-client-1.9:javaagent:testStableSemconv"
  ...
  "aws-sdk:aws-sdk-1.11:javaagent:testSqs"
  ...
  "google-http-client-1.19:javaagent:testStableSemconv"
  ...
  "http-url-connection:javaagent:testStableSemconv"
  ...
  "java-http-client:javaagent:testStableSemconv"
  ...
  "jetty-httpclient:jetty-httpclient-12.0:javaagent:testStableSemconv"
  ...
  "kafka:kafka-clients:kafka-clients-0.11:javaagent:testV3Preview"
  ...
  "kubernetes-client-7.0:javaagent:testStableSemconv"
  ...
  "netty:netty-4.0:javaagent:testStableSemconv"
  "netty:netty-4.1:javaagent:test"
  "netty:netty-4.1:javaagent:testStableSemconv"
  "okhttp:okhttp-2.2:javaagent:test"
  "okhttp:okhttp-2.2:javaagent:testStableSemconv"
  ...
  "ratpack:ratpack-1.7:javaagent:testStableSemconv"
  "ratpack:ratpack-1.7:library:test"
  "reactor:reactor-kafka-1.0:javaagent:test"
  "reactor:reactor-kafka-1.0:javaagent:testExperimental"
  ...
  "spring:spring-ws-2.0:javaagent:test"
  "spring:spring-ws-2.0:javaagent:testExperimental"
  ...
  "vaadin-14.2:javaagent:vaadin142Test"
  "vaadin-14.2:javaagent:vaadin16Test"
  ...
  "vertx:vertx-http-client:vertx-http-client-4.0:javaagent:testStableSemconv"
  "vertx:vertx-http-client:vertx-http-client-5.0:javaagent:test"
  "vertx:vertx-http-client:vertx-http-client-5.0:javaagent:testStableSemconv"
  "vertx:vertx-kafka-client-3.6:vertx-kafka-client-3.6-testing:test"
  "vertx:vertx-kafka-client-3.6:vertx-kafka-client-3.6-testing:testExperimental"
